    ...
    >
      <div className="hero-content" style={{ maxWidth: "800px", background: "rgba(18, 18, 18, 0.6)", padding: "2rem", borderRadius: "1rem", backdropFilter: "blur(4px)" }}>
        <h1 style={{ 
          ...
          <span style={{ color: "var(--accent-color)" }}>Blindamos tu Industria</span> con Tecnología y Cumplimiento Normativo
        </h1>
        <p style={{ 
          fontSize: "1.25rem", 
          ...
          Consultoría Integral en Seguridad e Higiene e Infraestructura Cloud Segura (ISO 27001 & AWS). Donde la seguridad física se encuentra con el futuro digital.
        </p>
        <button 
