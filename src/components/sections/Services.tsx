  ...
  return (
    <section style={{ padding: "8rem 2rem", position: "relative", zIndex: 10 }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "2.5rem", marginBottom: "4rem", color: "var(--accent-color)", textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem" }} className="services-grid">
          ...
          <div className="service-card" style={{
            ...
            <h3 style={{ fontSize: "1.8rem", marginBottom: "1rem" }}>Seguridad e Higiene Industrial</h3>
            <p style={{ color: "var(--text-muted)", lineHeight: "1.6", marginBottom: "2rem" }}>
              Liderado por María Eugenia. Protección física integral para entornos de alto riesgo.
            </p>
          ...
          <div className="service-card" style={{
            ...
            <h3 style={{ fontSize: "1.8rem", marginBottom: "1rem" }}>Ciberseguridad e Infraestructura Cloud</h3>
            <p style={{ color: "var(--text-muted)", lineHeight: "1.6", marginBottom: "2rem" }}>
